...
# cs111-F2017-lab5-solution

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the solution for Laboratory 5 in Computer Science 111.
...
* The `WordHide` program must:
  ...
  * Produce a total of 26 lines of output
...
```
Gregory M. Kapfhammer Thu Sep 28 09:16:52 EDT 2017
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-111-F2017/cs111-F2017-lab5-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-111-F2017/cs111-F2017-lab5-starter)
